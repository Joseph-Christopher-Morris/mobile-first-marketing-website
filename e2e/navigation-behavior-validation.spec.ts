...
test.describe('Navigation Behavior Validation', () => {
  ...
  test.describe('Desktop Navigation (≥768px)', () => {
    ...
    test('should show full navigation menu without hamburger icon', async ({ page }) => {
    ...
    test('should navigate correctly when clicking desktop navigation links', async ({ page }) => {
    ...
    test('should maintain navigation visibility at different desktop screen sizes', async ({ page }) => {
      const desktopSizes = [
  ...
  test.describe('Mobile Navigation (<768px)', () => {
    ...
    test('should show hamburger menu and hide desktop navigation', async ({ page }) => {
    ...
    test('should maintain mobile navigation at different small screen sizes', async ({ page }) => {
      const mobileSizes = [
  ...
  test.describe('Navigation Accessibility', () => {
    test('should have proper ARIA attributes', async ({ page }) => {
      ...
      await page.setViewportSize({ width: 375, height: 667 });
      const hamburgerButton = page.locator('button[aria-label="Toggle mobile menu"]');
      await expect(hamburgerButton).toHaveAttribute('aria-label', 'Toggle mobile menu');
      await expect(hamburgerButton).toHaveAttribute('aria-expanded', 'false');
