...
{
  type __IsExpected<Specific extends AppPageConfig<'/services/[slug]'>> =
    Specific;
...
// Validate ../../src/app/test-image-error-handling/page.tsx
{
  type __IsExpected<
    Specific extends AppPageConfig<'/test-image-error-handling'>,
  > = Specific;
  const handler =
    {} as typeof import('../../src/app/test-image-error-handling/page.js');
  type __Check = __IsExpected<typeof handler>;
  // @ts-ignore
  type __Unused = __Check;
}
