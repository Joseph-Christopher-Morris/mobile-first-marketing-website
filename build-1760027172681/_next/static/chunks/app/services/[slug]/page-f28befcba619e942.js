(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [805],
  {
    43: (e, t, a) => {
      'use strict';
      a.d(t, { ServiceContactForm: () => c });
      var r = a(5155),
        s = a(2115);
      a(5904);
      const n = new Map();
      class o {
        static validateFormData(e) {
          var t, a, r, s;
          const n = [];
          if (
            ((null == (t = e.name) ? void 0 : t.trim())
              ...
              : n.push({ field: 'name', message: 'Name is required' }),
            (null == (a = e.email) ? void 0 : a.trim())
              ? /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e.email) ||
                n.push({
                  field: 'email',
                  message: 'Please enter a valid email address',
                })
              : n.push({ field: 'email', message: 'Email is required' }),
            (null == (r = e.subject) ? void 0 : r.trim())
              ? e.subject.trim().length < 3 &&
                n.push({
                  field: 'subject',
                  message: 'Subject must be at least 3 characters long',
                })
              : n.push({ field: 'subject', message: 'Subject is required' }),
            (null == (s = e.message) ? void 0 : s.trim())
              ? e.message.trim().length < 10
                ? n.push({
                    field: 'message',
                    message: 'Message must be at least 10 characters long',
                  })
                : e.message.trim().length > 5e3 &&
                  n.push({
                    field: 'message',
                    message: 'Message must be less than 5000 characters',
                  })
              : n.push({ field: 'message', message: 'Message is required' }),
            e.phone && e.phone.trim())
          ) {
            const t = e.phone.replace(/\D/g, '');
            /^[\+]?[1-9][\d]{0,15}$/.test(t) ||
              n.push({
                field: 'phone',
        ...
        static checkForSpam(e) {
          const t = ''
              ...
              .concat(e.company || '')
              .toLowerCase(),
            a = this.SPAM_KEYWORDS.some(e => t.includes(e.toLowerCase())),
            r = (t.match(/https?:\/\//g) || []).length,
            s = /(.)\1{6,}/.test(t),
            n =
              (e.message.match(/[A-Z]/g) || []).length >
                0.5 * e.message.length && e.message.length > 20;
          return a || r > 2 || s || n;
        }
        static checkRateLimit(e) {
          const t = Date.now(),
            a = (n.get(e) || []).filter(e => t - e < this.RATE_LIMIT_WINDOW);
          return (n.set(e, a), a.length >= this.MAX_SUBMISSIONS_PER_WINDOW);
        }
        static recordSubmission(e) {
          const t = Date.now(),
            a = n.get(e) || [];
          (a.push(t), n.set(e, a));
        }
        ...
        static async sendEmailNotification(e) {
          try {
            return (await new Promise(e => setTimeout(e, 500)), !0);
          } catch (e) {
            return !1;
          }
        }
        static async sendAutoReply(e) {
          try {
            return (await new Promise(e => setTimeout(e, 300)), !0);
          } catch (e) {
            return !1;
          }
        }
        static async processSubmission(e, t) {
          try {
            const r = this.validateFormData(e);
            if (r.length > 0)
              return {
                success: !1,
            ...
            const s = {
              ...
              n = t.ipAddress || s.email;
            if (this.checkRateLimit(n))
              return {
                success: !1,
                message:
                  'Too many submissions. Please wait a moment before trying again.',
              };
            if (this.checkForSpam(s))
              return (
                this.recordSubmission(n),
                {
                  success: !1,
                  message:
            ...
            const o = this.generateSubmissionId();
            this.recordSubmission(n);
            const [i, l] = await Promise.all([
              this.sendEmailNotification(s),
              this.sendAutoReply(s),
            ]);
            return (
              a(2514).Ay.trackFormSubmission('general_contact', {
                service: s.service,
                submission_id: o,
              }),
              {
      ...
      async function i(e) {
        try {
          ...
          const r = o.generateSubmissionId();
          try {
            const e = {
                name: a.name,
                email: a.email,
                ...
                service: a.service || '',
                message: a.message,
                _subject: 'New Contact Form: '.concat(a.subject),
                _replyto: a.email,
              },
              t = await fetch('https://formspree.io/f/xovkngyr', {
                method: 'POST',
                headers: {
              ...
              );
            {
              ...
              throw Error(
                'Formspree error: '.concat(t.status, ' - ').concat(e)
              );
            }
          } catch (e) {
            return {
      ...
      ((o.RATE_LIMIT_WINDOW = 6e4),
        (o.MAX_SUBMISSIONS_PER_WINDOW = 3),
        (o.SPAM_KEYWORDS = [
          'viagra',
          'casino',
          'lottery',
      ...
      function c(e) {
        let { service: t } = e,
          ...
          x = async e => {
            (e.preventDefault(), d(!0), c({}), h(null));
            try {
              const e = {
                  ...a,
                  subject: ''
                    .concat(t.title, ' Inquiry - ')
                    .concat(a.projectType || 'General'),
                  service: ''.concat(t.title, ' (').concat(t.slug, ')'),
                  message: 'Project Type: '
                    .concat(
                      a.projectType || 'Not specified',
                      '\nBudget Range: '
                    )
                    .concat(a.budget || 'Not specified', '\nTimeline: ')
                    .concat(
                      a.timeline || 'Not specified',
                      '\n\nProject Details:\n'
                    )
                    .concat(a.message),
                },
                r = await i(e);
              if ((h(r), r.success))
                (l.Ay.trackFormSubmission('service_inquiry', {
                  service: t.slug,
        ...
        return (null == u ? void 0 : u.success)
          ? (0, r.jsxs)('div', {
              className:
              ...
              children: [
                ...
                u.submissionId &&
                  (0, r.jsxs)('p', {
                    ...
                    children: ['Reference ID: ', u.submissionId],
                  }),
                (0, r.jsx)('button', {
                  onClick: () => {
                    (h(null),
                ...
                (0, r.jsxs)('div', {
                  ...
                  children: [
                    (0, r.jsxs)('h3', {
                      ...
                      children: ['Get Started with ', t.title],
                    }),
                    (0, r.jsx)('p', {
                      className: 'text-gray-600',
                      children:
                        "Tell us about your project and we'll provide a customized quote and timeline.",
                    }),
                  ],
                }),
                (0, r.jsxs)('form', {
                        ...
                        (0, r.jsxs)('div', {
                          children: [
                            ...
                            (0, r.jsx)('input', {
                              ...
                              onChange: b,
                              className:
                                'w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors '.concat(
                                  o.name ? 'border-red-300' : 'border-gray-300'
                                ),
                        ...
                        (0, r.jsxs)('div', {
                          children: [
                            ...
                            (0, r.jsx)('input', {
                              ...
                              className:
                                'w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors '.concat(
                                  o.email ? 'border-red-300' : 'border-gray-300'
                                ),
                        ...
                        (0, r.jsxs)('div', {
                          children: [
                            ...
                            (0, r.jsx)('input', {
                              ...
                              className:
                                'w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors '.concat(
                                  o.phone ? 'border-red-300' : 'border-gray-300'
                                ),
                    ...
                    (0, r.jsxs)('div', {
                      children: [
                        (0, r.jsx)('label', {
                          ...
                          className:
                            'block text-sm font-medium text-gray-700 mb-2',
                          children: 'Preferred Timeline (Optional)',
                        }),
                        (0, r.jsxs)('select', {
                          id: 'timeline',
                          name: 'timeline',
                    ...
                    (0, r.jsxs)('div', {
                      children: [
                        ...
                        (0, r.jsx)('textarea', {
                          ...
                          onChange: b,
                          className:
                            'w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-vertical '.concat(
                              o.message ? 'border-red-300' : 'border-gray-300'
                            ),
                          placeholder: 'Tell us more about your '.concat(
                            t.title.toLowerCase(),
                            ' needs...'
                          ),
                        }),
    ...
    740: (e, t, a) => {
      ...
      function l(e) {
        ...
        let {
          ...
          g = (0, o.usePathname)(),
          p = s
            ? ''.concat(s, ' | Mobile-First Marketing')
            : 'Mobile-First Marketing Agency | Photography, Analytics & Ad Campaigns',
          b = m.startsWith('http') ? m : ''.concat(i).concat(m),
          x = h || ''.concat(i).concat(g),
          f = [
            'mobile marketing',
          ...
          y = {
            ...
            ...(d && {
              ...
              author: { '@type': 'Person', name: d.author || 'Marketing Team' },
              publisher: {
                '@type': 'Organization',
                name: 'Mobile-First Marketing',
                logo: {
                  '@type': 'ImageObject',
                  url: ''.concat(i, '/images/logo.png'),
                },
              },
              articleSection: d.section,
              keywords: null == (t = d.tags) ? void 0 : t.join(', '),
            }),
          };
        return (0, r.jsxs)(n(), {
          children: [
            (0, r.jsx)('title', { children: p }),
            (0, r.jsx)('meta', { name: 'description', content: l }),
            (0, r.jsx)('meta', { name: 'keywords', content: f }),
            (0, r.jsx)('link', { rel: 'canonical', href: x }),
            u &&
              (0, r.jsx)('meta', {
                name: 'robots',
            ...
            (0, r.jsx)('meta', {
              property: 'og:type',
              content: d ? 'article' : 'website',
            }),
            (0, r.jsx)('meta', { property: 'og:title', content: p }),
            (0, r.jsx)('meta', { property: 'og:description', content: l }),
            (0, r.jsx)('meta', { property: 'og:image', content: b }),
            (0, r.jsx)('meta', { property: 'og:url', content: x }),
            (0, r.jsx)('meta', {
              property: 'og:site_name',
              content: 'Mobile-First Marketing',
            }),
            (0, r.jsx)('meta', { property: 'og:locale', content: 'en_US' }),
            d &&
              (0, r.jsxs)(r.Fragment, {
                children: [
                  d.publishedTime &&
            ...
            (0, r.jsx)('meta', { name: 'twitter:title', content: p }),
            (0, r.jsx)('meta', { name: 'twitter:description', content: l }),
            (0, r.jsx)('meta', { name: 'twitter:image', content: b }),
            (0, r.jsx)('meta', {
              name: 'viewport',
              content: 'width=device-width, initial-scale=1, maximum-scale=5',
            }),
            (0, r.jsx)('meta', { name: 'theme-color', content: '#000000' }),
            (0, r.jsx)('meta', {
    ...
    2514: (e, t, a) => {
      ...
      ((s.isInitialized = !1), (s.debugMode = !1));
      const n = s;
    },
    2548: (e, t, a) => {
      'use strict';
        ...
        l = e => {
          ...
          const H = _
              ? {
                  ...
                  url: t,
                  description: a,
                  width: null == o ? void 0 : o.toString(),
            ...
            U = {
              ...
              quality: g,
              className: ''
                .concat(d, ' transition-all duration-500 ')
                .concat(L ? 'opacity-100 scale-100' : 'opacity-0 scale-105'),
              sizes:
                h ||
                '(max-width: '.concat(
                  m,
              ...
              placeholder: p,
              blurDataURL: 'blur' === p ? G : void 0,
              onLoad: () => {
                (E(!0), O(!1), $(!1), null == y || y());
              },
              onError: e => {
                if (
                  (q('Failed to load image: '.concat(D)), O(!1), N && D !== N)
                ) {
                  (z(N), V(0), O(!0));
                  return;
                }
          ...
          if (I && A && !L)
            return (
              ...
              (0, r.jsx)('div', {
                ...
                style: { width: u ? '100%' : o, height: u ? '100%' : l },
                children: (0, r.jsxs)('div', {
          ...
          const X = () => {
            if (u)
              return (0, r.jsx)('div', {
                ...
                children: (0, r.jsx)(n.default, { ...U, fill: !0 }),
              });
            if (!o || !l)
              throw Error('Width and height are required when fill is false');
            return (0, r.jsx)(n.default, { ...U, width: o, height: l });
          };
          return w
            ? (0, r.jsxs)(r.Fragment, {
                children: [
                  ...
                  (0, r.jsxs)('figure', {
                    ...
                    children: [
                      ...
                      (0, r.jsx)('meta', { itemProp: 'url', content: t }),
                      (0, r.jsx)('meta', {
          ...
          o =
            ...
            (function (e) {
              let {
                  ...
                  removeQueryParams: r = !0,
                } = e,
                s = t;
              return (
                r && s.includes('?') && (s = s.split('?')[0]),
                a && '/' !== s && s.endsWith('/') && (s = s.slice(0, -1)),
                s.startsWith('/') || (s = '/'.concat(s)),
                ''.concat('http://localhost:3000').concat(s)
              );
            })({ path: n }),
          i = (function (e) {
            const t =
    ...
    3608: (e, t, a) => {
      (Promise.resolve().then(a.t.bind(a, 2619, 23)),
        ...
        Promise.resolve().then(a.bind(a, 43)),
    ...
    5370: (e, t, a) => {
      ...
      function o(e) {
        let t,
          { type: a = 'organization', data: o } = e;
        switch (((0, s.usePathname)(), a)) {
          case 'organization':
          default:
            t = {
              '@context': 'https://schema.org',
          ...
          case 'service':
            t = {
              '@context': 'https://schema.org',
              '@type': 'Service',
              name: o.name || 'Marketing Service',
              description: o.description || 'Professional marketing service',
              provider: {
                '@type': 'Organization',
                name: 'Mobile-First Marketing',
                url: n,
              ...
              serviceType: o.serviceType || 'Marketing',
  ...
  e => {
    (e.O(0, [619, 851, 441, 255, 358], () => e((e.s = 3608))), (_N_E = e.O()));
  },
]);
