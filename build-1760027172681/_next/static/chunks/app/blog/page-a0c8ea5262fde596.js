  ...
  [831],
  {
    ...
    1265: (e, r, t) => {
      ...
      var o = t(5155),
        ...
        a = t.n(s);
      function i(e) {
        const { isOpen: r, onClose: t, navigationItems: s, currentPath: i } = e;
    ...
    6201: (e, r, t) => {
      ...
      function s() {
        ...
        e)
          ? (0, o.jsx)('section', {
              className:
                'bg-gradient-to-r from-green-500 to-green-600 py-12 md:py-16',
              children: (0, o.jsxs)('div', {
                ...
                children: [
                  ...
                  (0, o.jsx)('p', {
                    ...
                    children:
                      "You've successfully subscribed to our newsletter. You'll receive the latest photography tips, industry insights, and success stories in your inbox.",
                  }),
                  (0, o.jsx)('button', {
                    onClick: () => r(!1),
                    className:
                      'bg-white text-green-600 px-6 py-3 rounded-lg font-semibold hover:bg-green-50 transition-colors focus:outline-none focus:ring-4 focus:ring-white focus:ring-offset-2 focus:ring-offset-green-600',
          ...
          : (0, o.jsx)('section', {
              className:
                'bg-gradient-to-r from-pink-500 to-pink-600 py-12 md:py-16',
              children: (0, o.jsxs)('div', {
                className: 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center',
                children: [
                  (0, o.jsx)('h2', {
                  ...
                  (0, o.jsx)('p', {
                    ...
                    children:
                      'Subscribe to our newsletter and get the latest photography tips, industry insights, and success stories delivered to your inbox.',
                  }),
                  (0, o.jsxs)('form', {
                    ...
                    children: [
                      ...
                      (0, o.jsx)('input', {
                        ...
                        name: '_next',
                        value:
                          'https://d15sc9fc739ev2.cloudfront.net/blog?subscribed=true',
                      }),
                      (0, o.jsx)('input', {
                        type: 'hidden',
                        name: 'type',
                      ...
                      (0, o.jsx)('label', {
                        ...
                        className: 'sr-only',
                        children: 'Email address for newsletter subscription',
                      }),
                      (0, o.jsx)('input', {
                        id: 'newsletter-email',
                        name: 'email',
                        ...
                        className:
                          'flex-1 px-4 py-3 rounded-lg border border-pink-300 focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent text-gray-900 placeholder-gray-500',
                      ...
                      (0, o.jsx)('button', {
                        type: 'submit',
                        className:
                          'bg-gray-900 text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-800 transition-colors focus:outline-none focus:ring-4 focus:ring-white focus:ring-offset-2 focus:ring-offset-pink-600 border-2 border-gray-900 shadow-lg',
    ...
    6591: (e, r, t) => {
      (Promise.resolve().then(t.t.bind(t, 2619, 23)),
        ...
        Promise.resolve().then(t.bind(t, 6201)));
    },
  },
  e => {
    (e.O(0, [619, 441, 255, 358], () => e((e.s = 6591))), (_N_E = e.O()));
  },
]);
