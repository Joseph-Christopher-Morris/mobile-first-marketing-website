  ...
  return (
    <div className='container mx-auto px-4 py-8'>
      <h1 className='text-3xl font-bold mb-8'>
        Image Error Handling Test Page
      </h1>
      ...
      <div className='mt-12 p-6 bg-gray-100 rounded-lg'>
        ...
        <ul className='space-y-2 text-sm'>
          <li>
            <strong>Test 1:</strong> Should load successfully and show the
            analytics screenshot
          </li>
          <li>
            <strong>Test 2:</strong> Should show loading, then retry indicators,
            then error message
          </li>
          <li>
            <strong>Test 3:</strong> Should fail initially, then load the
            fallback image
          </li>
          <li>
            <strong>Test 4:</strong> Should show custom error message
          </li>
          <li>
            <strong>Test 5:</strong> Should show custom loading component
            briefly
          </li>
          <li>
            <strong>Test 6:</strong> Should show custom error component
          </li>
          <li>
            <strong>Test 7:</strong> Should load without showing loading
            indicator
          </li>
          <li>
            <strong>Test 8:</strong> Should show error state but without text
            message
          </li>
          <li>
            <strong>Test 9:</strong> Should show error in fill mode
          </li>
        </ul>
        <p className='mt-4 text-sm text-gray-600'>
          Open browser developer tools to see detailed logging of the image
          loading process.
        </p>
      </div>
    </div>
