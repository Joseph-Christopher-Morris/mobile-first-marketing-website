...
export default function ServicesPage() {
  ...
  const schema = {
    ...
    sameAs: [
      "https://www.facebook.com/...", // add if applicable
    ...
    "@graph": [
      {
        ...
        mainEntity: [
          ...
          {
            "@type": "Question",
            name: "Do you photograph cars for dealerships and private sellers?",
            acceptedAnswer: {
              "@type": "Answer",
              text:
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="text-center mb-10">
          ...
          <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
            We help Cheshire businesses grow with professional automotive media,
            data analytics, and ROI-focused ad campaigns. Browse our core
            services below and see how we improve visibility and conversions.
          </p>
        </header>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="p-6">
              <p className="text-gray-600">
                High quality car photography for Cheshire dealerships, auctions,
                and private sellers. Clean lighting, panel-true angles, and
                mobile-ready delivery that increases enquiries.
              </p>
          ...
          >
            ...
            <div className="p-6">
              <p className="text-gray-600">
                We implement tracking, build dashboards, and translate data into
                actions. Get clear reports on campaign performance and website
                behaviour so you can invest with confidence.
              </p>
              <span className="mt-5 inline-flex items-center text-brand-pink hover:text-brand-pink2 font-semibold">
                Learn More
                <svg className="ml-2 w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
          ...
          >
            ...
            <div className="p-6">
              <p className="text-gray-600">
                Search and social campaigns that reach buyers near Nantwich and
                across Cheshire. We optimise creatives, audiences, and budgets
                to improve lead quality and ROI.
              </p>
              <span className="mt-5 inline-flex items-center text-brand-pink hover:text-brand-pink2 font-semibold">
                Learn More
                <svg className="ml-2 w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        <section className="mt-20 text-gray-700 leading-relaxed max-w-4xl mx-auto">
          ...
          <p className="mb-4">
            We combine automotive media, analytics, and marketing tech so local
            brands see real outcomes. Dealerships, garages, restorers, and
            events teams in Nantwich and the wider Cheshire area use our work to
            increase enquiries, improve conversion rates, and cut wasted ad
            spend.
          </p>
          <p>
            Ready to plan your next shoot or campaign?{" "}
            <Link href="/contact" className="text-brand-pink hover:text-brand-pink2 font-semibold">
              Talk to us
            </Link>{" "}
