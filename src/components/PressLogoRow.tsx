...
export function PressLogoRow({ variant, className = "" }: Props) {
  const logos = variant === "home" ? HOME_LOGOS : PHOTO_LOGOS;

  return (
    <div
      className={`max-w-5xl mx-auto grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-x-8 gap-y-4 items-center justify-items-center ${className}`}
