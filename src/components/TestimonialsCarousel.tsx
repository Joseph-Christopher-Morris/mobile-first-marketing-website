    ...
    <section className='testimonials-carousel-section'>
      <div className='testimonials-carousel-container'>
        ...
        <div className='testimonials-carousel-header'>
          <h2 className='testimonials-carousel-title'>{title}</h2>
          <p className='testimonials-carousel-subtitle'>{subtitle}</p>
        </div>
          ...
          <div className='testimonials-carousel-card'>
            ...
            <div className='testimonials-carousel-stars'>
              {[...Array(5)].map((_, i) => (
                <svg
                  key={i}
                  className={`testimonials-carousel-star ${
                    i < currentTestimonial.rating ? 'active' : ''
                  }`}
                  fill='currentColor'
                  viewBox='0 0 20 20'
                >
