      ...
      <section className="bg-gradient-to-r from-green-500 to-green-600 py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-green-100 mb-8 max-w-2xl mx-auto">
            You've successfully subscribed to our newsletter. You'll receive the latest photography tips, 
            industry insights, and success stories in your inbox.
          </p>
          <button
    ...
    <section className="bg-gradient-to-r from-pink-500 to-pink-600 py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <input type="hidden" name="_next" value="https://d15sc9fc739ev2.cloudfront.net/blog?subscribed=true" />
