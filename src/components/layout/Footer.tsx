          ...
          <div className='col-span-1 md:col-span-2'>
            ...
            <div className='flex space-x-4 mt-6'>
              <a
                ...
                aria-label='Facebook - Vivid Media Cheshire'
              >
                <svg
                  className='w-5 h-5'
                  fill='currentColor'
              ...
              <a
                href='https://www.linkedin.com/in/joe-morris-07921a1a0/'
                target='_blank'
                rel='noopener noreferrer'
                className='text-gray-400 hover:text-white transition-colors p-2 rounded-lg hover:bg-gray-800 min-w-[44px] min-h-[44px] flex items-center justify-center'
                aria-label='LinkedIn - Joe Morris'
              >
                <svg
                  className='w-5 h-5'
                  fill='currentColor'
              ...
              <a
                href='https://github.com/Joseph-Christopher-Morris'
                target='_blank'
                rel='noopener noreferrer'
                className='text-gray-400 hover:text-white transition-colors p-2 rounded-lg hover:bg-gray-800 min-w-[44px] min-h-[44px] flex items-center justify-center'
                aria-label='GitHub - Joseph Christopher Morris'
              >
                <svg
                  className='w-5 h-5'
                  fill='currentColor'
