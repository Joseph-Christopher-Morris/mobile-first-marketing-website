...
const post: BlogPost = {
  ...
  content: `
    ...
    <p>In 2022 and 2023, I began slimming down my Hot Wheels car collection to earn a little extra income. At the same time, I wanted to learn the basics of e-commerce and customer service.</p>

    <p>Through photographing each vehicle, editing images, and writing accurate and engaging descriptions, I aimed to create a great experience for every buyer. These early sales helped build a reputation for reliability.</p>

    <p>Alongside this, I was freelancing as a photographer for classic car auctions. With strong market demand, I was able to sharpen my skills in both photography and vehicle presentation.</p>

    <h2>A Seasonal Shift</h2>

    <p>As autumn arrived, auction shoots slowed down. The darker evenings and colder days pushed me back toward eBay, where I focused on selling as many Hot Wheels as possible before Christmas. Positive customer feedback helped me improve my workflow and listings, and I began to double down on strategies that worked.</p>

    <h2>The Ford Opportunity</h2>
    ...
    <p>This article kicks off a deeper look into how I turned an opportunity into a process.<br />
    Over the next parts, I'll cover studio workflow, listing strategy, business insights, and how I managed customers and returns.</p>

    <p>If you're exploring small-scale eCommerce or want help presenting your collection professionally, feel free to reach out.</p>
